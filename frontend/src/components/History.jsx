...
import { getDummyHistoryPage } from "@services/dummyData";
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.warn("Using dummy history data as fallback.");
        const dummy = getDummyHistoryPage(page, PER_PAGE);
        setItems(dummy.results);
        setCount(dummy.count);
      } finally {
        setLoading(false);
      }
    };
